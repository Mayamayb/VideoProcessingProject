...
def stabilize(video_name_input = 'INPUT.avi',video_name_output = 'stabilized.avi'):
    ...
    for i in range(n_frames - 1):
        ...
        A, inliers = ransac((prev_pts, curr_pts), AffineTransform, min_samples=5,
                            residual_threshold=2, max_trials=k)
        A=A.params[:2,:]
        # Extract translation
        dx = A[0, 2]
        dy = A[1, 2]
        ...
        print("Frame: " + str(i+1) + "/" + str(n_frames-1) + " -  Tracked points : " + str(len(prev_pts)))
